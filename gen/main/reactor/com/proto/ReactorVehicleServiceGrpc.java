...
public final class ReactorVehicleServiceGrpc {
    ...
    public static final class ReactorVehicleServiceStub extends io.grpc.stub.AbstractStub<ReactorVehicleServiceStub> {
        ...
        public reactor.core.publisher.Flux<com.proto.Vehicle.GetModelByMakeAndYearResponse> getModelByMakeAndYear(reactor.core.publisher.Flux<com.proto.Vehicle.GetModelByMakeAndYearRequest> reactorRequest) {
            return com.salesforce.reactorgrpc.stub.ClientCalls.manyToMany(reactorRequest, delegateStub::getModelByMakeAndYear, getCallOptions());
        }
    ...
    public static abstract class VehicleServiceImplBase implements io.grpc.BindableService {
        ...
        public reactor.core.publisher.Flux<com.proto.Vehicle.GetModelByMakeAndYearResponse> getModelByMakeAndYear(reactor.core.publisher.Flux<com.proto.Vehicle.GetModelByMakeAndYearRequest> request) {
            throw new io.grpc.StatusRuntimeException(io.grpc.Status.UNIMPLEMENTED);
        }
        ...
        @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                    ...
                    .addMethod(
                            com.proto.VehicleServiceGrpc.getGetModelByMakeAndYearMethod(),
    ...
    public static final int METHODID_GET_MODEL_BY_MAKE_AND_YEAR = 3;
            ...
            switch (methodId) {
                ...
                case METHODID_GET_MODEL_BY_MAKE_AND_YEAR:
                    return (io.grpc.stub.StreamObserver<Req>) com.salesforce.reactorgrpc.stub.ServerCalls.manyToMany(
                            ...
                            serviceImpl::getModelByMakeAndYear, serviceImpl.getCallOptions(methodId));
                default:
                    throw new java.lang.AssertionError();
            }
        }
